...
public class DetailedReportQuarantineController extends GenericAbstractListController<ProductSerie> {
    ...
    public void onClick$btnDownload() throws InterruptedException {
        try {
            ...
            AccessControl.saveAction(Permission.QUARANTINE, "Se descargo reporte de productos en quarentena formato excel");
        } catch (Exception ex) {
            showError(ex);
        }
    }
