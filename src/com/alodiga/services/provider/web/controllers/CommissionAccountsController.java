...
//
//public class CommissionAccountsController extends GenericAbstractListController<Account> {
//
...
//                    item.appendChild(new Listcell(userEJB.getAccountProductCalculationByAccountId(account.getId(),Product.ELECTRONIC_PIN_ID) + " %"));
//                    item.appendChild(new Listcell(userEJB.getAccountProductCalculationByAccountId(account.getId(),Product.TOP_UP_PRODUCT_ID) + " %"));
...
//        try {
//            Utils.exportExcel(lbxRecords, Labels.getLabel("sp.crud.commission.list"));
//        } catch (Exception ex) {
//            showError(ex);
//        }
//    }
