...
public class ListAddQuarantineController extends GenericAbstractListController<Product> {
    ...
    public void loadList(Product product) {
        try {
            ...
            if (product != null ) {
                ...
                List<ProductSerie> producSeries = transactionEJB.searchProductSerieByProductId(product.getId(), Category.QUARANTINE);
