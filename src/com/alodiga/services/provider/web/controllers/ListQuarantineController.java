...
public class ListQuarantineController extends GenericAbstractListController<Product> {
...
//                    item.appendChild(permissionRead  && stock>0? new ListcellViewButton("listAddQuarantine.zul", product,Permission.VIEW_QUARANTINE) : new Listcell());
    ...
    public void onClick$btnSearch() throws InterruptedException {
        try {
            ...
            AccessControl.saveAction(Permission.QUARANTINE, "Se busco listado de productos en quarentena");
        } catch (Exception ex) {
            showError(ex);
        }
    }
