...
public class AdminEgressQuarantineController extends GenericAbstractAdminController {
...
//    	intQuantity.setReadonly(true);
    ...
    public void loadFields(Product product) {
		...
		try {
    		List<ProductSerie>  productSeries = transactionEJB.searchProductSerieByProductId(product.getId(), Category.QUARANTINE);
