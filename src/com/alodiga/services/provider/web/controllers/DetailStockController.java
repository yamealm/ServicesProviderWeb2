...
public class DetailStockController extends GenericAbstractListController<Product> {
	...
	private void deleteProductSerie(Listitem listItem) {
		try {
			Messagebox.show(Labels.getLabel("sp.common.actions.delete.question"), Labels.getLabel("sp.common.actions.delete.confirm"), Messagebox.YES | Messagebox.NO,
						...
						public void onEvent(final Event evt) throws InterruptedException {
							if ("onYes".equals(evt.getName())) {
								try {
									...
									AccessControl.saveAction(Permission.REMOVE_STOCK,"product = " + productSerie.getProduct().getId() + " and product serie = "
